...
API_KEY = os.environ.get("API_KEY","877792113")

API_HASH = os.environ.get("API_HASH","AAGlVYTMGIuYzp1UXtuKqYu98zVnqX9Lq18")

TRING_SESSION = os.environ.get("STRING_SESSION", None)
